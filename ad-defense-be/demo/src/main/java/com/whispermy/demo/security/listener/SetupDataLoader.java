...
import com.whispermy.demo.domain.entity.*;
import com.whispermy.demo.repository.*;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void setupSecurityResources() {
        ...
        createResourceIfNotFound("com.whispermy.demo.aopsecurity.method.AopMethodService.methodTest", "", roles1, "method");
        createResourceIfNotFound("com.whispermy.demo.aopsecurity.method.AopMethodService.innerCallMethodTest", "", roles1, "method");
        createResourceIfNotFound("execution(* com.whispermy.demo.aopsecurity.pointcut.*Service.*(..))", "", roles1, "pointcut");
